...
class StatePieChart(context: Context, attributes: AttributeSet): PieChart(context, attributes), OnChartValueSelectedListener{
    ...
    fun configureCountry(activeCases:String,deaths:String,totalRecovered:String) {
        ...
        this.setOnChartValueSelectedListener(this@StatePieChart)
        this.invalidate()
    }
