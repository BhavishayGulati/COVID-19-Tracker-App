...
class CountryPieChart(context: Context, attributes: AttributeSet): PieChart(context, attributes), OnChartValueSelectedListener{

    fun configureCountry(activeCases:String,deaths:String,totalRecovered:String) {
        this.centerText = ""
        ...
        entries.add(PieEntry(activeCases.replace(",","").toFloat()-deaths.replace(",","").toFloat()-totalRecovered.replace(",","").toFloat(), resources.getString(R.string.confirmed)))
        entries.add(PieEntry(totalRecovered.replace(",","").toFloat(), resources.getString(R.string.cured)))
        entries.add(PieEntry(deaths.replace(",","").toFloat(), resources.getString(R.string.dead)))
        ...
        this.setOnChartValueSelectedListener(this@CountryPieChart)
        this.invalidate()
    }
